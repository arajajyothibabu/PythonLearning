...
def test_identity_equality_small_numbers():
    ...
    Becuase numbers(int) in the range -5 to 256 creates a defualt object with in some address location
    So this the peculiar reason for this behavior
    """
    a = b = 10
    assert True == (a is b)
    assert True == ( a == b)
...
-Peculiar behavior of numbers in the range -5 to 256
