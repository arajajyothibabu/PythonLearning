...
def test_tuples_are_immutable():
    ...
    try:
        ...
        print te # note the exception  ###TypeError: 'tuple' object does not support item assignment
        assert True
...
def min_max(input):
    ...
    """
    #return (input[0:1]+input[len(input)-1:])  # write a line of code to return containing min and max
...
-Tuples and their indexing and slicing
-Tuples with single element and tuple nesting
-sequence conversion and finding MIN_MAX using range
"""
