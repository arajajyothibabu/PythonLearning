...
def odd_desc(count):
    ...
    """
    range1 = range(1, 2 * count, 2)
    range1.sort(reverse=True)
    return range1
...
-Lists and their functions like append, insert, extend, pop etc
-list slicing, merging, lists in lists
-range with sort functions and reverse facility
"""