...
def test_assert_true_with_message():
    assert True, "This is the failure message Araja Jyothi Babu" # replace ___ with True to stop seeing the assertion error
...
-checking Strings equality and other logical operations
-In python functions don't have {BRACES} to indicate blocks of code
"""
