...
def test_valid_dictionary_keys():
    ...
    try:
        ...
        print te  #observe the error message. #####TypeError: unhashable type: 'list'
        assert True
    ...
    try:
        ...
        print te
        assert True # do we reach here?## NOT REACHED
    ...
    try:
        ...
        print te
        assert True #do we reach here? YES:::#####TypeError: unhashable type: 'list'
...
-sets with lookup functionality(dicts)
-functions like del to delete an element in dict, valid keys, usage of hashable tuples rather than unhashable lists
-creating empty dict and functions of dict like keys() and values() and items()
"""
