...
def test_equality():
    ...
    assert True == (0 == False) # what happened here? Since 0, 1 are treated as boolean values
    assert True == (1 == True)
    assert False == ("a" == True)
...
-Truth values of data types and new CLASS OBJECT "None" and it's value is False
-Truthness of objects is different from equality of its values with boolean value
-Treatment with control flow statements is different from their actual truth values
"""
