    ...
    if count == 1:
        ...
        while y in range(count * count):
            ...
            if c == count:
                break
            y += 1
    return output   # fill up the code in this method
...
-Control statements like for and while together with special functionality like for_else and while_else
-statements like Continue, Break etc
-Implementation of nested_if and other conditional statements
"""