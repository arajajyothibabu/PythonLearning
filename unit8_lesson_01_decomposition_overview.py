...
notes = '''
 ...
 wont internalize them on a single read or even a two reads!
...
The decomposition will happen in the piazza group. Once you guys agree on a decomposition, I will upload the file with
the agreed upon skeleton that everyone has to fill up and get working.
'''