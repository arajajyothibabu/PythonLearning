...
-checking the data type :whether string or not
-different representations of strings and string indexing
-concataination, slicing, formatting and also rotating contents of string
"""
